      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center space-y-8 mb-16">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-teal-500 bg-clip-text text-transparent">
            Hi, I'm Swagatika Behera
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            I'm a passionate student, currently pursuing MCA (master of Computer Application).
            Skilled in Java,Python & Frontend Development.
            Seeking Opportunity in Software Development, testing & IT consulting.
          </p>
        </div>
